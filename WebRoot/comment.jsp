...
<script type="text/javascript">
		...
		function submitComment(){
		     var flag = getFlag();
		     document.form1.action = "addCommentAction?flag="+flag;
		     document.form1.submit(); 
		}
		
		function getFlag(){
		  var value="";
		  var radio=document.getElementsByName("ra_comment");
	      ...
	      <tr>
		     ...
		     <th class="qty">总价</th>
		      ...
		      <tr>
			     ...
			     <td class="qty">${goods_order.goods.goods_price}</td>
			     <td class="bg price">${goods_order.order.count}</td>
			     <td class="qty">${goods_order.order.total_price}</td>
		      </tr>
       </table>

       </div><!-- .grid_12 -->
      <form name=form1 action="" method="post" >
			<input class="niceRadio" type="radio" name="ra_comment" value="1" />好评
			<input class="niceRadio" type="radio" name="ra_comment" value="0" />中评
			<input class="niceRadio" type="radio" name="ra_comment" value="-1" />差评
            <br/>

	       <textarea rows="10" cols="100" name="comment" id="comment"></textarea>
	       <br/>
           <input type="button" id="btn_submit" style="background-image:url(images/tijiaopinglun.png);width:100px;height:35px" onclick="submitComment()"/>
       </form>
</div>
</section>
