  ...
  <body onload="isLogin()">
    ...
    <div id="top">
      ...
      <div class="grid_6" id="unlogin">
        <div class="welcome">
           <a href="login.jsp">请登录</a> &nbsp;&nbsp;&nbsp;<a href="login.jsp">免费注册</a>
        </div><!-- .welcome -->
      </div><!-- .grid_6 -->
      ...
      <h3>订单付款成功！</h3><a href="index.jsp"><input type="submit" name="continue_shopping" value="继续购物" style="font-size:18px"/></a>
